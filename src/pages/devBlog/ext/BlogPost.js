                        ...
                        >
                            <div
                                ...
                                <div className="gradient-bg">
                                    ...
                                    <div className="px-4">
                                    <span
                                        className="text-blue-600 dark:text-blue-400 text-sm font-medium uppercase pl-1">{props.info.keyword}</span>
                                        <br/>
                                        <span
                                            className="text-gray-800 dark:text-white font-semibold text-6xl mt-2 hover:no-underline hover:text-gray-600 dark:hover:text-gray-200 hover:underline">{props.info.title}</span>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gray-200 dark:bg-gray-700 px-11">
                                    ...
                                    <button className="py-2 px-4 mt-9 mb-10 capitalize text-xl tracking-wide bg-blue-600 text-white font-medium rounded hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
